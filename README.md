...
[Скачать MarkEdit для Windows (x64)](https://github.com/amoorkie/markedit/releases/latest/download/MarkEdit-Windows-1.33.1-win.11-Setup.exe)

Текущая версия: `1.33.1-win.11`.
...
2. Запустите `MarkEdit-Windows-1.33.1-win.11-Setup.exe`.
