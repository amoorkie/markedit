...
[Скачать MarkEdit для Windows (x64)](https://github.com/amoorkie/markedit/releases/latest/download/MarkEdit-Windows-1.33.1-win.15-Setup.exe)

Текущая версия: `1.33.1-win.15`.
...
2. Запустите `MarkEdit-Windows-1.33.1-win.15-Setup.exe`.
