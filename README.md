...
[Скачать MarkEdit для Windows (x64)](https://github.com/amoorkie/markedit/releases/latest/download/MarkEdit-Windows-1.33.1-win.6-Setup.exe)

Текущая версия: `1.33.1-win.6`.
...
- файловый сайдбар с быстрым доступом, папкой текущего файла и всеми дисками компьютера;
- ленивое раскрытие папок без предварительного сканирования всего диска;
...
2. Запустите `MarkEdit-Windows-1.33.1-win.6-Setup.exe`.
